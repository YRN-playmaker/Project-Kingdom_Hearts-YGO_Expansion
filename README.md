...
<img src="https://img.shields.io/badge/Platform-EDOPro%20%2F%20YGOPro2-blue?style=flat-square" alt="Platform">
<img src="https://img.shields.io/badge/Scripts-Lua-orange?style=flat-square" alt="Lua">
<img src="https://img.shields.io/badge/Cards-75%2B-success?style=flat-square" alt="Cards">
<img src="https://img.shields.io/badge/License-MIT-green?style=flat-square" alt="License">

</div>

## 🚩 Project Overview
This is a custom Yu-Gi-Oh! expansion set based on the **Kingdom Hearts** universe. It includes **70+ designed cards**, with over **30+ cards fully scripted** and playable.

To play, simply copy the expansion files into your EDOPro/YGOPro `expansions` folder.
...
### ⚖️ Disclaimer
**Artworks and Character Designs** are the property of **Square Enix / Disney** (Kingdom Hearts) and **Konami** (Yu-Gi-Oh!). This repository is a fan project and is not affiliated with these companies.
The Lua scripts are licensed under the **MIT License**.
